...
class Deferral {
  ...
  constructor () {
    ...
    // bind the resolver and rejecter methods to this instance
...
/**
 * @class A Promises/A+ compliant promise library
 */
...
class Potential {
  ...
  /**
   * Construct a new {link Deferral} instance.
   * @returns {Deferral} TODO FILL IN
   */
   ...
   * N.B. while the output promise is normally fulilled, if `resulve` is called
 ...
 *
 * @property {function} then - Presumptive method to attach handlers.
 */
